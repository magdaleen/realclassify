...
can be computed. In subsection~\ref{subsec:blowing_up} we discuss the
computational aspect of blowing a singularity up, a technique which we use
e.g.\@ in Algorithm~\ref{alg:D_4}. As a last prerequisite for the
classification, we show that the homogeneous parts of lowest degree of two
right equivalent functions factorize in the same way over $\R$
