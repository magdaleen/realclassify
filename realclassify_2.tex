...
\begin{remark}
Let $w$ be a weight on the variables in $\K[[x_1,\ldots,x_n]]$. Throughout
this paper we always assume that the weighted degree of $x_i$, denoted by $w
\dash \deg(x_i)$, is a natural number for each $i = 1, \ldots, n$.
\end{remark}
...
\end{align*}
By definition of the piecewise weight $w_0$, any term in $\phi_0^{w_0}(x)$ also
