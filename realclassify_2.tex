...
\begin{defn}
Let $\K$ be either $\R$ or $\C$, let $f, g \in \K[[x_1, \ldots, x_n]]$ be two
power series, and let $S \subset \Aut_{\K}(\K[[x_1,\ldots,x_n]])$ be a subset
of the set of $\K$-algebra automorphisms of $\K[[x_1, \ldots, x_n]]$.
\begin{enumerate}
...
for some $r \in \K$ where $\K$ is either $\C$ or $\R$. For those cases we use
