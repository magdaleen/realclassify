...
\begin{abstract}
In the classification of real singularities by \citet{AVG1985} normal forms, as representatives of equivalence classes under right equivalence,
are not always uniquely determined. We describe the complete structure of the
equivalence classes of the unimodal real singularities of corank~$2$. That is, we explicitly answer the question when equivalences between normal forms of different type occur, and how a normal form can be transformed within the same equivalence class, by only changing the value of the parameter. This provides new theoretical insights into these singularities and has
...
normal forms of type $\tY_r$ and type $Y_{r,r}$.
...
\begin{figure}
\caption{Equivalences between $NF(\tY_r^+)$ and $NF(Y_{r,r}^{++})$%
...
To sum up, the normal forms in \citet{AVG1985} which are
listed in these classifications cover the whole space of unimodal
