...
classes of the unimodal real singularities of corank~$2$. That is, we
explicitly answer the question when equivalences between normal forms of
different type occur, and how a normal form can be transformed within the same
equivalence class, by only changing the value of the parameter. This provides
